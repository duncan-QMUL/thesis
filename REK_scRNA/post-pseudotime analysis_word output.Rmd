...
cluster_labels <- c("Small", "Mid-stage","Late-stage", "End-stage")

VlnPlot(kerato, features = c("percent.mt")) + scale_x_discrete(name ="Cluster", limits=c("2","3","1", "0"), labels=cluster_labels) + ggtitle("Percentage mitochondrial RNA") + theme(axis.title.x = element_blank())

VlnPlot(kerato, features = c("nFeature_RNA")) + scale_x_discrete(name ="Cluster", limits=c("2","3","1", "0"), labels=cluster_labels) + ggtitle("Number of features") + theme(axis.title.x = element_blank())


VlnPlot(kerato, features = c("nCount_RNA")) + scale_x_discrete(name ="Cluster", limits=c("2","3","1", "0"), labels=cluster_labels) + ggtitle("Number of counts") + theme(axis.title.x = element_blank())
